      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-rose-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6 animate-gradient-text bg-gradient-to-r from-gray-900 via-rose-600 to-gray-900 bg-clip-text">
              Featured Products
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our most loved products, carefully selected for their
              effectiveness and gentle formulations.
            </p>
          </div>
                    ...
                    >
                      <CardContent className="p-0">
                        <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-t-lg overflow-hidden relative">
                          ...
                          {product.onSale && (
                            <Badge className="absolute top-3 right-3 bg-red-600 animate-pulse-glow shadow-lg">
                              Sale
                            </Badge>
                          )}
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                            <div className="flex gap-3 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                              <Button
                                size="sm"
                                className="bg-white text-gray-900 hover:bg-rose-600 hover:text-white transition-all duration-300 shadow-xl hover:scale-110 animate-bounce-gentle"
                              >
                                <Heart className="w-4 h-4" />
                              </Button>
                              <Button
                                size="sm"
                                className="bg-[#BF6159] hover:bg-[#a8443b] transition-all duration-300 shadow-xl hover:scale-110 animate-bounce-gentle"
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <span className="text-xl font-bold text-[#BF6159] group-hover:animate-pulse">
                                ${product.price}
                              </span>
                            ...
                            <Button
                              size="sm"
                              className="bg-[#BF6159] hover:bg-[#9e423a] transform hover:scale-110 transition-all duration-300 shadow-md hover:shadow-xl"
                            >
          ...
          >
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-[#BF6159] text-[#BF6159] hover:bg-[#a74037] hover:text-white  bg-white transform hover:scale-110 transition-all duration-500 hover:shadow-xl text-lg px-8 py-4"
            >
