  ...
  const filteredAndSortedProducts = useMemo(() => {
    const filtered = products.filter((product) => {
      ...
      const concernMatch =
        ...
        selectedConcerns.some((concern) => product.concerns.includes(concern));
                ...
                >
                  <CardContent className="p-0">
                    <div className="aspect-square bg-gray-100 rounded-t-lg overflow-hidden relative">
                      ...
                      {product.isNew && (
                        <Badge className="absolute top-2 left-2 bg-green-600 animate-pulse">
                          New
                        </Badge>
                      )}
                      {product.onSale && (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <div className="flex gap-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                          ...
                          <Button
                            size="sm"
                            className="bg-rose-600 hover:bg-rose-600 transition-all duration-300 shadow-lg"
                          >
                            Quick Add
                          </Button>
                        </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-lg font-bold text-[#BF6159] group-hover:animate-pulse">
                            ${product.price}
                          </span>
                        ...
                        <Button
                          size="sm"
                          className="bg-[#BF6159] hover:bg-[#92413a] transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg"
                        >
