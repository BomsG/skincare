...
export default function AboutPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Community",
      description:
        "We're building a community of people who support each other on their skincare journeys.",
      color: "blue",
    },
    {
      icon: Award,
  ...
  const milestones = [
    {
      year: "2020",
      event: "SkinCare founded with a mission to democratize clean beauty",
    },
    {
      year: "2021",
      event:
        "Launched our first product line with 5 essential skincare products",
    },
    {
      year: "2022",
      event: "Reached 10,000 happy customers and expanded to 15 products",
    },
    {
      year: "2023",
      event:
        "Opened our first retail location and launched the skin quiz feature",
    },
    {
      year: "2024",
      event: "Celebrating 50,000+ customers and 25 award-winning products",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-rose-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#BF6159] to-[#91332a] text-white py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1
            className={`text-5xl md:text-6xl tracking-wide font-serif font-bold mb-6 transition-all duration-1000 ${
          ...
          <p
            className={`text-[14px] md:text-[19px] tracking-wider mb-8 opacity-90 max-w-3xl mx-auto transition-all duration-1000 ${
              isVisible ? "animate-fade-in-up" : ""
            }`}
            style={{ animationDelay: "0.2s" }}
          >
            We're on a mission to make professional-grade, clean skincare
            accessible to everyone, helping you achieve healthy, glowing skin
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <div className="space-y-4 text-lg text-gray-700">
                <p>
                  SkinCare was born from a simple belief: everyone deserves
                  access to effective, clean skincare products that actually
                  work. Our founder, Dr. Sarah Johnson, noticed that many of her
                  patients were struggling to find products that were both
                  gentle and effective.
                </p>
                <p>
                  After years of research and development, we created a line of
                  products that combines the best of nature and science. Each
                  formula is carefully crafted with clean, proven ingredients
                  and rigorously tested for safety and efficacy.
                </p>
                <p>
                  Today, we're proud to serve thousands of customers worldwide,
                  helping them achieve their best skin while staying true to our
                  values of transparency, sustainability, and inclusivity.
                </p>
              </div>
              <Button
                asChild
                className="mt-8 bg-[#BF6159] hover:bg-[#8c3c35] text-lg px-8 py-4"
              >
                <Link href="/products">
            ...
            <div className="animate-slide-in-right">
              <img
                src="/images/simg3.jpg?height=500&width=600"
                alt="Our story"
                className="w-[556px] h-[456px] rounded-2xl shadow-2xl"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our passionate team of experts is dedicated to bringing you the
              best in clean, effective skincare.
            </p>
          </div>
      ...
      {/* Our Journey */}
      <section className="py-20 px-4 bg-gradient-to-r from-[#BF6159] to-[#91332a] text-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl font-serif font-bold mb-6">Our Journey</h2>
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              From a small startup to a trusted skincare brand, here are the key
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're proud to be recognized for our commitment to quality,
            ...
            {[
              {
                ...
                description:
                  "Certified by Leaping Bunny, ensuring no animal testing",
                icon: "🐰",
              },
              {
                title: "Clean Beauty Award 2024",
                description:
                  "Recognized for excellence in clean beauty formulations",
                icon: "🏆",
              },
              {
                title: "Dermatologist Tested",
                description:
                  "All products tested and approved by board-certified dermatologists",
                icon: "👩‍⚕️",
              },
              {
                title: "Sustainable Packaging",
                description:
                  "Committed to eco-friendly and recyclable packaging",
                icon: "♻️",
              },
              {
                title: "FDA Compliant",
                description:
                  "All products meet FDA safety and quality standards",
                icon: "✅",
              },
              {
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-[#591f19] to-[#91332a] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-serif font-bold mb-6 animate-fade-in-up">
            Ready to Start Your Skincare Journey?
          </h2>
          <p
            className="text-xl mb-8 opacity-90 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            Join thousands of happy customers who trust SkinCare for their daily
            routine.
          </p>
          <div
