...
const categories = ["All", "Skincare Basics", "Skin Science", "Ingredients", "Routines"]
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-rose-50">
      ...
      <section className="bg-gradient-to-r from-rose-600 to-pink-600 text-white py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 animate-fade-in-up">Skincare Blog</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
            ...
            <Button
              ...
              className={`transition-all duration-300 hover:scale-105 ${
                selectedCategory === category
                  ...
                  : "border-rose-300 text-rose-700 hover:bg-rose-50 bg-transparent"
              }`}
            >
              {category}
            </Button>
                ...
                >
                  <CardContent className="p-0">
                    <div className="aspect-video bg-gray-100 overflow-hidden relative">
                      ...
                      <Badge className="absolute top-4 left-4 bg-rose-600 animate-pulse-glow">Featured</Badge>
                    </div>
                    <div className="p-6">
        ...
        {/* Newsletter Signup */}
        <section className="mt-20 bg-gradient-to-r from-rose-600 to-pink-600 rounded-2xl p-8 md:p-12 text-white text-center animate-fade-in-up">
