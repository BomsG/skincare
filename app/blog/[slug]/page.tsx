      ...
      <section className="relative bg-gradient-to-r from-rose-600 to-pink-600 text-white py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="text-center">
            <Badge className="mb-4 bg-white/20 text-white animate-bounce-gentle">{post.category}</Badge>
            <h1
              className={`text-4xl md:text-5xl font-serif font-bold mb-6 transition-all duration-1000 ${isVisible ? "animate-fade-in-up" : ""}`}
            >
              {post.title}
            </h1>

            <div
              className={`flex items-center justify-center gap-6 text-white/90 mb-8 transition-all duration-1000 ${isVisible ? "animate-fade-in-up" : ""}`}
            ...
            <p
              className={`text-xl opacity-90 max-w-3xl mx-auto transition-all duration-1000 ${isVisible ? "animate-fade-in-up" : ""}`}
              ...
              <div className="flex items-center gap-4">
                <Button
                  ...
                  className={`transition-all duration-300 hover:scale-105 ${
                    isLiked ? "bg-rose-50 border-rose-300 text-rose-600" : "bg-transparent"
                  }`}
                >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-8">
              ...
              <Card className="shadow-lg border-0 animate-slide-in-right">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Board-certified dermatologist with over 15 years of experience in skincare and cosmetic treatments.
                  </p>
              ...
              {relatedPosts.length > 0 && (
                <Card className="shadow-lg border-0 animate-slide-in-right" style={{ animationDelay: "0.2s" }}>
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      {relatedPosts.map((relatedPost) => (
                        ...
                        >
                          <h4 className="font-medium text-sm text-gray-900 group-hover:text-rose-600 transition-colors duration-300 mb-1">
                            {relatedPost.title}
                          </h4>
              ...
              {/* Newsletter Signup */}
              <Card
                className="bg-gradient-to-r from-rose-600 to-pink-600 text-white shadow-lg border-0 animate-slide-in-right"
                style={{ animationDelay: "0.4s" }}
              >
                <CardContent className="p-6 text-center">
                  <h3 className="font-bold mb-2">Stay Updated</h3>
                  <p className="text-sm opacity-90 mb-4">Get the latest skincare tips delivered to your inbox</p>
